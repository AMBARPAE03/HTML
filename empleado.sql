...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2024 a las 16:20:16
...
CREATE TABLE `empleado` (
  ...
  `eps` enum('sanitas','sura','capital salud','nueva eps','famisanar','aliansalud') DEFAULT NULL,
  `pensiones` enum('colfondos','porvenir','skandia','proteccion') DEFAULT NULL,
